...
export default function App() {
  ...
  return (
    <div className="min-h-screen bg-[#FDFCF7] text-[#2C3E2B] font-sans relative overflow-hidden flex flex-col justify-between">
      ...
      <div className="absolute top-[-10%] left-[-10%] w-[40vw] h-[40vw] rounded-full bg-[#e9bd0d]/5 blur-[120px] pointer-events-none transform-gpu" />
      <div className="absolute bottom-[-10%] right-[-10%] w-[50vw] h-[50vw] rounded-full bg-[#6ea358]/5 blur-[150px] pointer-events-none transform-gpu" />
