...
// @ts-ignore
import meditatingWomanImg from './assets/images/woman_meditating_nature_1781017857296.png';
...
export default function App() {
  ...
  const handleShare = async () => {
    const shareData = {
      title: 'Goddess Reborn Meditation',
      text: 'Awaken your feminine power, confidence, and inner clarity with this guided meditation.',
  ...
  return (
    <div className="min-h-screen bg-[#FDFCF7] text-[#2C3E2B] font-sans relative overflow-hidden flex flex-col justify-between">
      ...
      <div className="absolute top-[-10%] left-[-10%] w-[40vw] h-[40vw] rounded-full bg-[#e9bd0d]/5 blur-[120px] pointer-events-none" />
      <div className="absolute bottom-[-10%] right-[-10%] w-[50vw] h-[50vw] rounded-full bg-[#6ea358]/5 blur-[150px] pointer-events-none" />
      ...
      {path === '/download' ? (
        ...
        <main className="flex-grow flex flex-col md:flex-row relative z-10 w-full max-w-7xl mx-auto md:px-6 md:py-8 lg:py-16 items-stretch">
          ...
          <div className="flex-1 min-h-[350px] md:min-h-0 md:h-auto relative group overflow-hidden md:rounded-3xl shadow-md border border-[#6ea358]/5 mb-8 md:mb-0">
            <img
